...
**User-Approved**: Traders must explicitly approve a builder and set a maximum fee (in basis points), which can be revoked at any time. This approval is stored onchain through the existing referral infrastructure, specifically in `UserStats`.
