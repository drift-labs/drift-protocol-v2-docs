...
Note: Funding rate hourly magnitudes are clamped according to the market's Contract Tier (>=B: 0.125%, C: 0.208%, <C: 0.4167%) and can be delayed at large divergences (see [Oracles](/trading/oracles)). Individual Market TWAP updates utilize the side of the book for trade executions, Bid and Ask TWAPs in the market are calculated and/or estimated on every trade.
