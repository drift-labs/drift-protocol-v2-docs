...
Perpetual Markets are bootstrapped by the [Drift AMM](/about-v3/drift-amm) which depending on market-making performance conditions can add and remove funds from the revenue pool.
