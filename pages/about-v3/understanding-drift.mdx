...
_For a more technical breakdown, check out:_[Matching Engine](/about-v3/matching-engine)
...
_For a more technical breakdown, check out:_[ Drift AMM](/about-v3/drift-amm)
...
Limit orders are placed by users on-chain. A network of Keeper Bots ([Keeper Bots](/about-v3/keepers)) then sorts the on-chain limit orders into an off-chain orderbook and categorises limit orders from oldest to newest, and largest to smallest.
...
_For a more technical breakdown, check out:_[ Decentralised Orderbook FAQ](/about-v3/decentralized-orderbook).
