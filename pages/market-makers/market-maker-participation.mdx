...
1.  Just-in-Time Liquidity (see [Matching Engine](/about-v3/matching-engine)); or

2.  Post-Only Orders on the decentralised orderbook (see [Keepers & Decentralised Orderbook](/about-v3/keepers-decentralized-orderbook-faq)).
...
For more information on JIT, check out [JIT Maker FAQ](/about-v3/jit-maker-faq).
