...
As the FUEL program continues to be rolled out, rewards for other activity like deposits/lending, borrowing, and having open interest will be added in the future.

## What are Boosters?

Activity boosters provide an accelerated earn rate for different activities. The boosted rate is added to the base eearn rate for the activity. Eample: if the base earn rate for taker volume is 1 FUEL for every \$1, and there's a booster of 5 FUEL for every \$1 in SOL-PERP, then the earn rate for SOL-PERP becomes 6 FUEL for every \$1 in taker volume as long as the booster is active.
