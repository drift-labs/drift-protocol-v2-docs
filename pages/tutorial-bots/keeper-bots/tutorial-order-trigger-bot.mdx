...
-   also maintain a local copy of the [Keepers & Decentralised Orderbook](/about-v3/decentralized-orderbook);
...
Follow the instructions at [Keeper Bots](/about-v3/keepers) to set the required environment variables and make sure a `ClearingHouseUser` is initialised.
