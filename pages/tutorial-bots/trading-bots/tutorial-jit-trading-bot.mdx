...
Market orders go through the [Just-In-Time (JIT) Auctions](/about-v3/matching-engine) where Makers fight to fill orders before the order is allowed to fill against the [Drift AMM](/about-v3/drift-amm).
