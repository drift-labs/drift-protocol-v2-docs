...
It's important to recognise the difference between **settling P&L** and **realising P&L** (read more here: [Introduction to Profit & Loss](/profit-loss/profit-loss-intro)).
