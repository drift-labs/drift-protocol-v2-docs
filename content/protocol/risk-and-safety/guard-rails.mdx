---
title: "Guard rails"
description: "Velocity refuses actions in a lot of places, and most refusals are the protocol working correctly. The ones a trader or integrator will actually hit, and the error each one raises."
---
