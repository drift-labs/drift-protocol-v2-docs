...
description: "Bankruptcy is what is left when liquidation runs out of things to take: the account still owes a debt and holds nothing that can pay it. Who absorbs that debt, and in what order."
---
