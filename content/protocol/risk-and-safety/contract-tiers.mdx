...
description: "Every perpetual market carries a tier from A to Isolated, and one admin instruction changes it. A new market defaults to HighlySpeculative, so a safer tier is always an explicit promotion."
---
