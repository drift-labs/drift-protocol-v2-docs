...
These risk parameters are relevant to perpetual futures. Further risk parameters are also set out in [Risks](/protocol/security/risks).
...
This risk is addressed in [Risks](/protocol/security/risks) and [P&L](/protocol/profit-loss/profit-loss-intro).
