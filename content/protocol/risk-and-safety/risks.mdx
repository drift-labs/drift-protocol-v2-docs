---
title: "Risks"
description: "Every mechanism that protects an account has a point past which it stops. This is the list of those points, and every parameter named is admin-settable unless stated otherwise."
---
...
OtterSec audited the post-fork program, and its [final report](/audit.pdf) is published: 154 findings, no Critical, and every High resolved. The program itself is not open source yet. See [Audits](/protocol/risk-and-safety/audits) and [Bug bounty](/protocol/risk-and-safety/bug-bounty).
