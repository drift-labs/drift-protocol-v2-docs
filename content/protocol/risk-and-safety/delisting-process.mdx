---
title: "Delisting"
description: "A perpetual has no expiry, but a market can still have to be closed. Velocity gives it an expiry on demand, then runs reduce-only, settlement price, settlement, and winding up the pools."
---
