...
- [Tutorial on how to run JIT trading bot](/developers/tutorial-bots/trading-bots/tutorial-jit-trading-bot)
...
Yes. We've developed an open-source maker bot that can be accessed [here](/developers/tutorial-bots/trading-bots/tutorial-jit-trading-bot).  
