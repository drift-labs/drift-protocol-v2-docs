...
- [Tutorial on how to run JIT trading bot](/developers/bots/trading-bots/tutorial-jit-trading-bot)
...
Yes. We've developed an open-source maker bot that can be accessed [here](/developers/bots/trading-bots/tutorial-jit-trading-bot).  
