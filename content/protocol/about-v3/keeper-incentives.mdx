...
For cancelling orders (that can be cancelled see [Advanced Orders FAQ](/protocol/trading/advanced-orders-faq)), Keepers will receive the `cancel_order_fee` on the state.
...
![plot of filler rewards (given user fee)](/assets/plot-fillet-rewards.png)
