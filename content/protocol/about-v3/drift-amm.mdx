...
Drift’s v3 AMM is still a AMM using a constant product curve but now includes external [Backstop AMM Liquidity (BAL)](/protocol/glossary) a concentration factor, and dynamic spread/peg that programmatically update prior to filling trades.
...
![Drift AMM Bid-Ask Spreads](/assets/drift-amm.png)
