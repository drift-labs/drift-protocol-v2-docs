...
description: "One balance per user fails on the first winning trade. The vaults that hold real tokens, the pools that are only accounting balances, and how value moves between them."
---
