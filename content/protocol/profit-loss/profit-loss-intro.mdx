...
<Callout type="warning" emoji="⚠️">
  ...
  [Types of P&L](/protocol/profit-loss/profit-loss-intro#types-of-pl) for more details.
</Callout>
...
5. Settled P&L (a portion of realized P&L) becomes available for **withdrawal** from the [P&L pool](/protocol/profit-loss/profit-loss-pool) if the pool has enough funds. If not, you might need to wait for others to settle their losses before you can withdraw your profits.
</Callout>
...
- P&L pool liquidity determines if settled [P&L pool](/protocol/profit-loss/profit-loss-pool) is claimable immediately.
