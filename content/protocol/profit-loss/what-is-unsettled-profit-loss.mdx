...
This pool is called the **P&L Pool** (read more here: [Accounting and Settlement](/protocol/profit-loss/accounting-settlement)).  
...
For more information on what happens when there is not enough Settled P&L, read [P&L Pool](/protocol/profit-loss/profit-loss-pool).
