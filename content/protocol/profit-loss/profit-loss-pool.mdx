...
![](/assets/8bAYsBqUpelsCx7xgTblP_drift-pandl-settlement-mechanism-banner-v2-1.png)
...
It's important to recognise the difference between **settling P&L** and **realising P&L** (read more here: [Introduction to Profit & Loss](/protocol/profit-loss/profit-loss-intro)).
...
![](/assets/L1J0T17SoiEsYYH8FO8MJ_image.png)
