...
![](/assets/IjPTQ7BZXMIhgNOt8IhYf_image.png)
...
Drift's interest rate is calibrated to manage liquidity risk and optimise asset utilisation. The formula for the borrow interest rates can be found at [Borrow Interest Rate](/protocol/lend-borrow/borrow-interest-rate).  
...
![](/assets/y_D7XVjmDvigSgXyl_n0e_image.png)
