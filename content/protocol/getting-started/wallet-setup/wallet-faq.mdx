...
Versioned transactions need to be turned on to use Drift's Swaps feature. Read more about versioned transactions and which wallets support it [here](/protocol/trading/versioned-transactions).
