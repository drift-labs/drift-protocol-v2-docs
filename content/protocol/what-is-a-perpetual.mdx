...
description: "A futures contract settles on a fixed date, and that date is the problem. What removing it breaks, how funding fixes it, and what the position actually is."
---
