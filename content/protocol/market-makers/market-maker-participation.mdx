...
_For more information on incentive programs for Market Makers, see_ [Maker Rebate Fees](/protocol/market-makers/maker-rebate-fees)

## Introduction

Any user can participate as a Market Maker on the platform. Market Makers can provide liquidity through either:  

1.  Just-in-Time Liquidity (see [Matching Engine](/protocol/about-v3/matching-engine)); or

2.  Post-Only Orders on the decentralised orderbook (see [Keepers & Decentralised Orderbook](/protocol/about-v3/keepers-decentralized-orderbook-faq)).
...
Market Makers can participate in the JIT system by running a JIT Maker Bot. For more information, check out [Tutorial: JIT Maker Bot](/developers/tutorial-bots/trading-bots/tutorial-jit-trading-bot)

For more information on JIT, check out [JIT Maker FAQ](/protocol/about-v3/jit-maker-faq).

## Decentralised Orderbook  

Makers can also provide liquidity to Drift's decentralised orderbook by quoting via the UI or programmatically through the [SDK Documentation](/protocol/sdk-documentation)  
