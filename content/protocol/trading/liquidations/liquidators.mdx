...
Bankruptcy (see [Insurance Fund](/protocol/insurance-fund/insurance-fund-intro) ) is possible if you still have outstanding liabilities and no further assets after liquidation.  
...
If you would like to run a liquidator bot, see [Tutorial: Liquidation Bot](/developers/tutorial-bots/keeper-bots/tutorial-liquidation-bot)