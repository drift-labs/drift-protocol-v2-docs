...
Under the Assets breakdown, you can see your deposited assets and Unsettled P&L. Unsettled P&L represents the unrealized profit or loss from open positions that have not yet been closed, fluctuating with market prices; it becomes realized when the positions are closed. More comprehensive explanation in [What is unsettled P&L?](/protocol/trading/profit-loss/what-is-unsettled-profit-loss)
