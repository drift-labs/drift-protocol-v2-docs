...
See [Trading Fees](/protocol/trading/trading-fees) and [Advanced Orders FAQ](/protocol/trading/advanced-orders-faq) for more information.
...
These orders take against the AMM and are executed by a decentralised network of keepers, see [Decentralised Orderbook FAQ](/protocol/about-v3/keepers-decentralized-orderbook-faq), once certain conditions are met (i.e. the mark price crosses the specified trigger/limit price).
