...
description: "Velocity is a fork of Drift v2 at SDK v2.163.0-beta.0, not an upgrade in place: a new program deployment, no onchain state carried over, and every PDA address different."
asIndexPage: true
---
