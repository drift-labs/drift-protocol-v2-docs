...
description: "Executable instructions for an AI coding agent migrating a TypeScript codebase from @drift-labs/sdk to @velocity-exchange/sdk: inventory, ordered procedure, symbol maps, and what to stop on."
---
