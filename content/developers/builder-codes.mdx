...
description: "How a frontend charges its own fee on the order flow it routes, set in the program itself: the identifier an order carries, the rate the user approves in advance, and when the fee is not charged."
---
