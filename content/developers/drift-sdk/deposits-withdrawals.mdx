...
```
  ...
  <Python name="driftpy.drift_client.DriftClient.convert_to_spot_precision">
```py
...
```
  ...
  <Python name="driftpy.drift_client.DriftClient.get_associated_token_account_public_key">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.drift_client.DriftClient.deposit">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.drift_client.DriftClient.withdraw">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.math.spot_balance.calculate_deposit_rate">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.math.spot_balance.calculate_borrow_rate">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="SPOT_MARKET_RATE_PRECISION">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
