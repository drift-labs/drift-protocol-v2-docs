...
```js
import { TEN, BN } from "@drift-labs/sdk";

// TEN = new BN(10), used internally for precision math.
// For example, to compute 10^decimals:
const decimals = 9; // SOL has 9 decimals
const precision = TEN.pow(new BN(decimals)); // BN(1_000_000_000)
