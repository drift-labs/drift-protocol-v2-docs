...
```
  ...
  <Python name="driftpy.drift_client.DriftClient.sign_signed_msg_order_params_message">
```py
...
```
  ...
  <Python name="driftpy.addresses.get_signed_msg_user_account_public_key">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="initializeSignedMsgUserOrders">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.drift_client.DriftClient.decode_signed_msg_order_params_message">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.drift_client.DriftClient.get_place_signed_msg_taker_perp_order_ixs">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.drift_client.DriftClient.get_place_and_make_signed_msg_perp_order_ixs">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.swift.util.generate_signed_msg_uuid">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.swift.util.digest_signature">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
...
```
  ...
  <Python name="driftpy.addresses.get_user_stats_account_public_key">
```py
# TODO: replace with a real DriftPy example
```
  </Python>
