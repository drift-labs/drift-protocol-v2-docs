...
description: "The errors a keeper or automation bot actually hits, from a missing token account to SpotMarketInterestStaleForMargin, TakerOrderNotFound, and a paused market, with what each one means."
---
