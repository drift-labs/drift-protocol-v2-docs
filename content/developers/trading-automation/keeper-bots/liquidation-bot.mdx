...
description: "A liquidation is a liability transfer, not a forced sale into the book: the liquidator takes the failing position onto its own books and is paid in the liquidatee's collateral at a discount."
---
