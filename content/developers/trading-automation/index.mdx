...
description: "For anyone running code that trades or maintains Velocity with no person at the keyboard. Which bot to run, what each is paid, and the workflows that need no persistent process at all."
asIndexPage: true
---
