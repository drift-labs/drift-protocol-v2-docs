---
title: "Data API"
description: "Indexed Velocity history over HTTP, so an app does not have to run its own indexer: what the API covers, its rate limits and request conventions, and where live trading state belongs instead."
---
