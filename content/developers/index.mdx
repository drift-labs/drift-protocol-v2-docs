...
description: "Velocity is a perpetual futures exchange that runs as a Solana program, with nothing between the trader and the chain except an RPC node. Where to start, and which of the two interfaces to build on."
---
