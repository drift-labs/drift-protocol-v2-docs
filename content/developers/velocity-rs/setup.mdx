---
title: "Setup"
description: "From an empty crate to a compiling dependency. Three steps cost people an afternoon: the crate is not on crates.io, an Apple Silicon host needs an x86_64 toolchain, and Solana is on the 3.x line."
---
