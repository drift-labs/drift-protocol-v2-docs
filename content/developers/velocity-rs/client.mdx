---
title: "The client"
description: "Constructing a VelocityClient from a network context, an RpcClient and a Wallet, the wallet modes it accepts, and the subscription model behind it over both WebSocket and gRPC."
---
