...
description: "TransactionBuilder assembles every transaction and owns the account resolution, so the caller describes the action and it works out the markets, oracles and user accounts to list."
---
