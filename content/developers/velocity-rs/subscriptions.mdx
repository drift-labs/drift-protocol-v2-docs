...
description: "A client subscription keeps account state current; these subscribers deliver changes. Program events, taker auctions, signed-message orders, and the slot, blockhash and priority fee streams."
---
