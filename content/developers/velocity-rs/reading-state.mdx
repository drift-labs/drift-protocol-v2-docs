---
title: "Reading state"
description: "Every read comes from the subscription cache or from RPC, and the method name decides which. Getting that wrong is the most common performance mistake in a bot built on this crate."
---
