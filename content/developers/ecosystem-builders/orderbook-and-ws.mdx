...
description: "The DLOB server's REST snapshots and websocket feed: the endpoints, the Redis cache behind most reads, and why the slot on each response is the only way to judge staleness."
---
