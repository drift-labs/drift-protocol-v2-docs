...
If you're not using `AuthorityDrift`, initialize a `DriftClient` directly: [SDK setup](/developers/drift-sdk/setup)

### Place and cancel orders

Use the SDK's order helpers for common flows: [Orders](/developers/drift-sdk/orders)

### Manage collateral and accounts

Deposits, withdrawals, and account lifecycle: [Deposits & withdrawals](/developers/drift-sdk/deposits-withdrawals), [Users](/developers/drift-sdk/users)

### Monitor risk and health

UI parity requires the same risk/health calculations: [PnL & risk](/developers/drift-sdk/pnl-risk)
