...
description: "Every way to send a transaction from an application: the high-level VelocityClient methods, and the stateless VelocityCore instruction builders for full control without a subscribed client."
---
