---
title: "Reading Data"
description: "Every way to read Velocity state from an application: the subscribed VelocityClient and User caches, the stateless VelocityCore decoders, and the Data API REST endpoints."
---
