...
description: "For teams building on top of Velocity rather than inside it: front ends, wallets, dashboards, indexers and aggregators. Setup, React apps, and staying current with the SDK."
asIndexPage: true
---
