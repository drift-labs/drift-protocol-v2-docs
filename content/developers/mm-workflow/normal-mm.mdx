...
“Normal” market making on Drift means placing **resting** two-sided quotes on the [decentralized orderbook](/protocol/about-v3/decentralized-orderbook) (orderbook / DLOB) and earning [maker rebates](/protocol/market-makers/maker-rebate-fees) when takers trade against you. You can also participate in JIT when relevant. For protocol background, see [Market Maker Participation](/protocol/market-makers/market-maker-participation) and [JIT FAQ](/protocol/about-v3/jit-faq).
