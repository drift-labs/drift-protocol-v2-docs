...
description: "Why a market maker that cannot step back has to manage depth through its parameters instead: how the AMM sizes depth, when it competes for a fill, and how the P&L it takes on is settled."
---
