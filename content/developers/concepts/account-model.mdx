---
title: "Account Model"
description: "The field-level reference for every account the program owns: what each one holds, how it is addressed, and where the layout differs from what an older integration expects."
---
