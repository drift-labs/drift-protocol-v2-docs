...
description: "The addresses of the two deployed programs and the other program IDs an integration points at, plus why every one of them should be read from the config rather than copied."
---
