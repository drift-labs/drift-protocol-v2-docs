...
description: "Solana's slot time is dropping from 400ms to 200ms in steps, so a slot count is no longer a stable unit of time. Where the live value lives onchain, and what it affects."
---
