---
title: "PnL & Risk"
description: "Health is an integer from 0 to 100 derived from total collateral against the maintenance margin requirement, and it short-circuits to 0 once an account is flagged, so 0 is a state, not just a number."
---
