...
description: "A spot swap routed through Jupiter or Titan from a Velocity account, wrapped in begin_swap and end_swap so both tokens move through the account's spot balances in one checked transaction."
---
