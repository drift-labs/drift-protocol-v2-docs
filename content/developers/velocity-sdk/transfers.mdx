---
title: "Transfers"
description: "Collateral is never shared between subaccounts under the same wallet, so moving it takes an explicit instruction. What transfers move, and how a delegate can do it."
---
