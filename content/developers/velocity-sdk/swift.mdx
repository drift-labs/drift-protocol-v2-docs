...
description: "The taker side of signed orders: sign an order message offchain, post it to the Swift API, and let a keeper land the fill. No transaction fee, no confirmation wait, settlement still onchain."
---
