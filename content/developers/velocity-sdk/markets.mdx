...
description: "Perp markets carry funding, spot markets are deposits and borrows that serve as collateral. Both are keyed by a numeric index whose mapping to a symbol must be resolved from the market accounts."
---
