...
description: "Every balance in a subaccount backs every position in it, which is what cross-margin means here. Balances are signed, carry interest in both directions, and are stored at the mint's own decimals."
---
