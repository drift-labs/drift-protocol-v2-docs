...
description: "Nothing in the SDK is a JavaScript number where money is involved. Every price, size and balance is a BN scaled by a fixed power of 10, with spot token amounts carrying the mint's own decimals."
---
