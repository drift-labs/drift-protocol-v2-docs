---
title: "Orders"
description: "A taker order fills by price, not by source: it walks the book and at each level the AMM quote, the resting order and any JIT quote compete, so one order can fill from more than one source."
---
