...
Trigger Bots are similar to [Tutorial: Order Matching Bot](/developers/tutorial-bots/keeper-bots/tutorial-order-matching-bot) in that they:
...
Follow the instructions at [Keeper Bots](/protocol/about-v3/keepers) to set the required environment variables and make sure a `ClearingHouseUser` is initialised.
