...
Refer to the [bot wallet setup](/protocol/getting-started/wallet-setup/bot-wallet-setup) tutorial for how to set up a bot wallet.
...
* `global.endpoint`: set this to your RPC endpoint (see [RPC Providers](/developers/tutorial-bots/rpc-providers))
