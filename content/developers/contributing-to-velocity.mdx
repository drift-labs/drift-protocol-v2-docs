...
description: "Velocity is not open source yet. What that leaves open to an outside contributor, which is a shorter list than most projects but not an empty one."
---
