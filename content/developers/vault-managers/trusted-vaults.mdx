...
description: "A normal vault is a box the manager can trade inside but cannot take assets out of. A Trusted vault removes the box: what it gates, how a borrow shows up in share price, and what a depositor is trusting."
---
