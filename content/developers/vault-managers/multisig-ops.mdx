...
description: "A vault's manager key is rare and irreversible, its delegate key signs thousands of orders a day. How to split them so the manager sits behind a multisig and the delegate stays hot."
---
