...
| :------------ | :--------- | :--------------- | :------ | --------------------------------------------------------------------------------- |
| Matching Bot  | Basic      | No               | TBD     | [Tutorial: Order Matching Bot](/developers/bots/keeper-bots/order-matching-bot)  |
| Order Trigger | Basic      | No               | TBD     | [Tutorial: Order Trigger Bot](/developers/bots/keeper-bots/order-trigger-bot)    |
...
| Bot Type      | Difficulty | Capital Required | Rewards | Link                                                                    |
| :------------ | :--------- | :--------------- | :------ | ----------------------------------------------------------------------- |
| JIT Maker Bot | Advanced   | Yes              | TBD     | [Tutorial: JIT Maker Bot](/developers/bots/trading-bots/jit-trading-bot)       |
