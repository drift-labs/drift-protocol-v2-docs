...
description: "Shares on a VaultDepositor PDA cannot be sent, held by a contract, or listed. Converting them into a standard SPL token, transferring it, and burning it back into shares."
---
