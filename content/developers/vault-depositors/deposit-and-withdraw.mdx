...
description: "Depositing is one step. Withdrawing is two, with a mandatory wait in between. Both flows, the states between them, and the errors each step can return."
---
