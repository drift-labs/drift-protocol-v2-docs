---
title: "SWIFT API"
description: "The maker side of signed orders: receiving and filling them. Why the standard onchain flow costs 2 to 4 seconds from taker intent to maker fill, and how SWIFT removes the wait."
---
