...
description: "Where a resting order sits and what beats it to a fill: the offchain DLOB that sorts orders held in user accounts, the fill plan the program builds, and the three ways to read the book."
---
