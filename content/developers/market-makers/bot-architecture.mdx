...
description: "Order placement is the smallest part of a bot that runs unattended. Staying subscribed, staying inside the compute and fee budget, and shutting down without leaving quotes on the book."
---
