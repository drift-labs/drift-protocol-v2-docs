---
title: "JIT-only MM"
description: "Market making with no standing book, reacting to incoming taker orders in real time: the subscribe, price, and atomic place-and-make loop, plus the filters that keep it safe."
---
