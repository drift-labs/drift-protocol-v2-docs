...
description: "How a maker signals liquidity offchain without committing an onchain order: publishing bids and asks to the websocket endpoint, stopping them, and how they appear in the book."
---
