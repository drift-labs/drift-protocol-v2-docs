---
title: "DLOB MM"
description: "Resting two-sided quotes on the orderbook and earning the maker rebate, which depends entirely on staying on the maker side: post-only, oracle offsets, atomic cancel-and-replace, and inventory skew."
---
