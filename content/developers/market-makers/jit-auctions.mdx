---
title: "JIT Auctions"
description: "Why a taker order opens an auction before it can reach the book or the AMM: the three parameters that define one, the price it walks, and how a maker takes part."
---
